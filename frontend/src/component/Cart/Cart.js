    ...
    <div>
      ...
      <div className="w-11/12 mx-auto ">
        {cartItems?.[0] ? (
          <div>
            {/* HEADER */}
            <h2 className="text-xl font-bold text-center p-1">YOUR CART</h2>
            {/* ACTIONS */}
          ...
          <Link to="/products">
          <button 
              className="border-dim-gray border rounded-md px-3 py-2 border-r-[2px] border-b-[2px] bg text-sm uppercase bg-midnight-green text-white  transition-transform hover:scale-105">
                Continue Shopping
              </button>
          </Link>
          </div>
